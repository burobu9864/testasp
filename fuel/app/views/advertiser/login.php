						...
						<form data-role="form" action="login" id="loginForm" name="loginForm" method="post">
							<div class="form-group row">
								<div class="col-sm-12" style="position: relative;">
									<input type="text" class="form-control" id="c_username" name="c_username" value=""
								...
								<div class="col-sm-12">
									<div class="form-check">
										<input class="form-check-input" type="checkbox" id="password_disp_flg"
											name="password_disp_flg" onclick="passwordDispOfClient(this.checked)">
							...
							<div class="form-group row">
								<div class="col-sm-12">
									<button type="submit" class="btn btn-primary btn-lg btn-block login_btn"
										name="clientlogin" value="login">LOG&nbsp;IN</button>
								</div>
							</div>
