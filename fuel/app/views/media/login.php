...
<body>
	<div class="footerFixed">
						...
						<form data-role="form" action="login" name="loginForm" method="post">
							<div class="form-group row">
								<div class="col-sm-12" style="position: relative;">
									<input type="text" class="form-control" id="p_username" name="p_username" value=""
										placeholder="ログインID" autofocus>
							...
							<div class="form-group row">
								<div class="col-sm-12" style="position: relative;">
									<input type="password" class="form-control" id="p_password" name="p_password"
										value="" placeholder="パスワード" onkeydown="goForm('loginForm',event.keyCode);">
							...
							<div class="form-group row">
								<div class="col-sm-12">
									<div class="form-check">
										<input class="form-check-input" type="checkbox" id="password_disp_flg"
											name="password_disp_flg" onclick="passwordDispOfPartner(this.checked)">
							...
							<div class="form-group row">
								<div class="col-sm-12">
									<button type="submit" class="btn btn-primary btn-lg btn-block login_btn"
										name="partnerlogin" value="login">LOG&nbsp;IN</button>
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-12">
									<div class="form-check">
										<input class="form-check-input" type="checkbox" id="p_persistent"
											name="p_persistent" value="yes">
		...
		<footer class="container text-center pt-3" style="font-size: 80%;">
			...
			<p><small style="font-size: 100%;">&copy; 2012 - 2024 <a href="https://www.lombard.co.jp"
						target="lombard">lombard inc.</a> All rights reserved.</small></p>
		</footer>
	</div>
